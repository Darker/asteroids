...
requirejs(deps, (ObjectDrawer, GravityWell, Spaceship, Projectile)=>{
    ...
    var planet;
    var rock;
    objs.push(planet = new GravityWell(-300, -300, 1e10, ObjectDrawer.textures.asteroid, DRAWER.stage));
    //objs.push(moon = new GravityWell(-450, -450, 5e8, ObjectDrawer.textures.asteroid, DRAWER.stage));
    //moon.orbitAround(planet);
    
    objs.push(rock = new GravityWell(-200, -200, 3e5, ObjectDrawer.textures.asteroid, DRAWER.stage));
    rock.vx = 0;
    rock.vy = 0.05;
